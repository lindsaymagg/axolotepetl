...
public class JuegaMolcajete : MonoBehaviour
{
    ...
    public GameObject mol0;
    public GameObject molA;
    public GameObject molS;
    public GameObject molW;
    ...
    private void OnEnable()
    {
        ...
        Debug.Log("Empieza MOLCAJETE.");
        currNumWins = 0;

        mol0.SetActive(true);
        molA.SetActive(false);
        molS.SetActive(false);
        molD.SetActive(false);
        molW.SetActive(false);
        ...
        counter = GameObject.FindGameObjectWithTag("CounterMol").GetComponent<TextMeshProUGUI>();
    ...
    {
        cheffy.master.EndMolcajete(exito);
